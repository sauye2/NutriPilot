...
export async function generateMealDraft(
  ...
  const prompt = [
    ...
    "Once the meal has enough protein, fill remaining calories with coherent carbs and fats rather than massively increasing the main protein portion.",
    "Avoid giant single-protein portions that push protein dramatically above the target just to reach calories.",
